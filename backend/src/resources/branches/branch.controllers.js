...
import { CustomError, createCustomError } from "../../errors/customErrors.js";
...
export const createNote = tryCatchWrapper(async function (req, res, next) {
    ...
    let sql = "INSERT INTO branches (title, contents) VALUES (?, ?)";
...
async function getNote(id) {
    let sql = "SELECT * FROM branches WHERE id = ?";
